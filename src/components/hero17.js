            ...
            {props.heading1 ?? (
              <Fragment>
                <span className="hero17-text7">
                  Discover Our Premium Cosmetic Products
                </span>
              </Fragment>
            )}
          </h1>
            ...
            {props.content1 ?? (
              <Fragment>
                <span className="hero17-text8">
                  Explore our exclusive range of high-quality cosmetic products
...
Hero17.defaultProps = {
  image3Src:
    '/images/dove1.jpg',
  image8Alt: 'Sophisticated Beauty Items',
  image2Src:
    '/images/evolu1.jpg',
  image6Alt: 'Glamorous Makeup Essentials',
  image11Src: '/images/nivea1.jpg',
  image5Alt: 'Elegant Beauty Products',
  image1Alt: 'Premium Cosmetic Products',
  image7Src:'/images/zara1.jpg',
  image7Alt: 'Chic Cosmetics Line',
  image12Alt: 'Trendy Cosmetics',
  image2Alt: 'Cosmetic Products Showcase',
  image6Src:'/images/wardi.jpg',
  image12Src:'/images/evolu.jpg',
  image3Alt: 'Beauty Products Display',
  image9Src:'/images/dove.jpg',
  image11Alt: 'Fashionable Beauty Products',
  action2: undefined,
  action1: undefined,
  image8Src:'/images/niveau.jpg',
  image5Src:'/images/topicrem.jpg',
  image4Src:'/images/rexona.jpg',
  image10Alt: 'Stylish Makeup Selection',
  image4Alt: 'Luxury Cosmetics Collection',
  heading1: undefined,
  content1: undefined,
  image10Src:
    '/images/niveau.jpg',
  image9Alt: 'Exclusive Skincare Range',
  image1Src:
    '/images/vaseline.jpg',
}
